      ...
      q-swipe-to-close(v-model="open")
        q-card.no-border-radius
          ...
          q-card-section.q-px-none.q-pt-md
            ...
            //-         outlined
            //-         bg-color="grey-2"
            //-         v-model="all_data.last_name"
            //-         label="Фамилия*"
            //-         color="red"
            //-       )
            //-         template.q-pa-none(
            //-           v-slot:append
            //-           v-if="isFull(all_data.last_name)"
            //-         )
            //-
            //- q-item
            //-   q-item-section
            ...
            //-         template.q-pa-none(
            //-           v-slot:append
            //-           v-if="isFull(all_data.first_name)"
            //-         )
            //-
            //- q-item
            //-   q-item-section
            ...
            //-         outlined
            //-         bg-color="grey-2"
            //-         v-model="all_data.patronymic"
            //-         label="Отчество*"
            //-         color="red"
            //-       )
            //-         template.q-pa-none(
            //-           v-slot:append
            //-           v-if="isFull(all_data.patronymic)"
            //-         )
            //-
            //- q-item
            //-   q-item-section
            ...
            //-         template.q-pa-none(
            //-           v-slot:append
            //-           v-if="isFull(all_data.passport_id)"
            //-         )
            //-
            //- q-item
            //-   q-item-section
            ...
            //-         outlined
            //-         bg-color="grey-2"
            //-         v-model="all_data.place_of_birth"
            //-         label="Место рождения*"
            //-         color="red"
            //-       )
            //-         template.q-pa-none(
            //-           v-slot:append
            //-           v-if="isFull(all_data.place_of_birth)"
            //-         )
            //-
            //- q-item
            //-   q-item-section
            ...
            //-         outlined
            //-         bg-color="grey-2"
            //-         v-model="all_data.code_subdivision"
            ...
            //-         template.q-pa-none(
            //-           v-slot:append
            //-           v-if="isFull(all_data.code_subdivision)"
            //-         )
            //-
            //- q-item
            //-   q-item-section
            ...
            //-         outlined
            //-         bg-color="grey-2"
            //-         v-model="all_data.name_of_passport_creator"
            //-         label="Наименование органа где выдан*"
            //-         color="red"
            //-       )
            //-         template.q-pa-none(
            //-           v-slot:append
            //-           v-if="isFull(all_data.name_of_passport_creator)"
            //-         )
            //-
            //- q-item
            //-   q-item-section
            ...
            //-         outlined
            //-         bg-color="grey-2"
            //-         v-model="all_data.place_of_live"
            //-         label="Место жительства*"
            //-         color="red"
            //-       )
            //-         template.q-pa-none(
            //-           v-slot:append
            //-           v-if="isFull(all_data.place_of_live)"
            //-         )
            //-
            q-item
              q-item-section
...
export default {
  ...
  data: () => ({
    ...
    subtitle: 'Паспортные данные (доп.)',
